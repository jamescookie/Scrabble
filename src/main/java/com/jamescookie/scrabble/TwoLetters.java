...
public class TwoLetters {
    ...
    static {
        ...
        TWO_LETTER_WORDS.add("ch");
        TWO_LETTER_WORDS.add("da");
        TWO_LETTER_WORDS.add("de");
        TWO_LETTER_WORDS.add("di");
        TWO_LETTER_WORDS.add("do");
        TWO_LETTER_WORDS.add("ea");
        TWO_LETTER_WORDS.add("ed");
        TWO_LETTER_WORDS.add("ee");
        ...
        TWO_LETTER_WORDS.add("ew");
        TWO_LETTER_WORDS.add("ex");
        TWO_LETTER_WORDS.add("fa");
        TWO_LETTER_WORDS.add("fe");
        TWO_LETTER_WORDS.add("fy");
        TWO_LETTER_WORDS.add("gi");
        TWO_LETTER_WORDS.add("go");
        TWO_LETTER_WORDS.add("gu");
        ...
        TWO_LETTER_WORDS.add("io");
        TWO_LETTER_WORDS.add("is");
        TWO_LETTER_WORDS.add("it");
        TWO_LETTER_WORDS.add("ja");
        TWO_LETTER_WORDS.add("jo");
        TWO_LETTER_WORDS.add("ka");
        TWO_LETTER_WORDS.add("ki");
        TWO_LETTER_WORDS.add("ko");
        TWO_LETTER_WORDS.add("ky");
        ...
        TWO_LETTER_WORDS.add("yu");
        TWO_LETTER_WORDS.add("za");
        TWO_LETTER_WORDS.add("ze");
        TWO_LETTER_WORDS.add("zo");
    }
